...
use common\models\HistoryUserSearch;
...
class HistoryController extends Controller
{
    ...
    /**
     * Displays a multiple History model.
     * @param integer $id
     * @return mixed
     */
    public function actionViewuser($id_user)
    {
        $searchModel = new HistoryUserSearch();
    ...
    {
        return [
            'message' => 'History tidak bisa dibuat secara manual'
        ];
    }
    ...
    {
        return [
            'message' => 'History tidak bisa diupdate'
        ];
    }
